...
A responsive recipe discovery web application built with **Angular 19** and **Angular Signals**. Users can browse, search, and filter a curated collection of healthy whole-food recipes.
